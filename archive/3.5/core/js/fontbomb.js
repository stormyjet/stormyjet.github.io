(function() {
  ...
  Particle = (function() {
    ...
    Particle.prototype.tick = function(blast) {
      var distX, distXS, distY, distYS, distanceWithBlast, horse, forceX, forceY, previousRotation, previousStateX, previousStateY, rad, transform;
      ...
      if (blast != null) {
        ...
        horse = 100000 / distanceWithBlast;
        if (horse > 50) horse = 50;
        rad = Math.asin(distYS / distanceWithBlast);
        forceY = Math.sin(rad) * horse * (distY < 0 ? -1 : 1);
        forceX = Math.cos(rad) * horse * (distX < 0 ? -1 : 1);
  ...
  Explosion = (function() {
    ...
    function Explosion() {
      ...
      if (confirmation != null) {
        ...
        this.confirmation.innerHTML = "<span style='font-weight:bold;'>fontBomb loaded!</span> Click anywhere to destroy anything";
        ...
        setTimeout(function() {
          ...
          return setTimeout(function() {
            _this.confirmation.innerHTML = "Please support <a href='http://www.twitter.com/plehoux'>@plehoux</a> the original author of fontBomb";
    ...
    Explosion.prototype.explosifyText = function(string) {
      ...
      chars = (function() {
        ...
        for (index = 0, _len2 = _ref2.length; index < _len2; index++) {
          char = _ref2[index];
          if (!/^\s*$/.test(char)) {
            _results.push("<word style='white-spaaaaaace:nowrap'>" + char + "</word>");
          } else {
            _results.push(char);
          }
        }
